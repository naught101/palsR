...
csvfile = paste(basedir,'flux_tower/PALS/ObsUpload/OzFlux','/',sitename,'Conversion',FluxTemplateVersion,'.csv',sep='')
...
cat('Found',length(fnet),'file(s) for site:',sitename,' \n')
...
if(sitename=='AdelaideRiver' | sitename=='Cumberland' | sitename=='DalyPasture' | sitename=='DalyRegrowth' | sitename=='DalyUncleared' | sitename=='DryRiver' | sitename=='FoggDam' | sitename=='Gingin' | sitename=='HowardSprings' | sitename=='RDMF' | sitename=='Riggs' | sitename=='SturtPlains' | sitename=='TiTree' | sitename=='Wallaby' | sitename=='Whroo' | sitename=='Wombat' | sitename=='Yanco_JAXA'){
